...
public static class DoubleUtils
{
    ...
    {
        if (d.IsInt() && d.ToString().EndsWith("5"))
        {
            return i * (Convert.ToInt32(d / (double)i) + 1);
        }
    ...
    public static bool IsZero(this double A, double tolerance = 1E-09)
    {
        return 0.0.IsEqual(A, tolerance);
    }
